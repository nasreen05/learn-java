...
class Hospital{
    ...
    public Hospital(int  numberOfBeds ) {
        this.numberOfBeds = numberOfBeds;

    }
        public Hospital(int numberOfDoctors, String hospitalName) {
            this.numberOfDoctors = numberOfDoctors;
            this.hospitalName=hospitalName;
        }
        public  Hospital(int numberOfDoctors, String hospitalName, String location){
        this.numberOfDoctors=numberOfDoctors;
            this.hospitalName=hospitalName;
            this.numberOfBeds=numberOfBeds;
    }
